...
# Autor: Xuan Sun
# Fecha: 03/11/2024
# Resumen: Script que muestra información de la sesión.
...
Help() {
  ...
  echo "[-u user1...] Deberá ir acompañada de un nombre de usuario o varios. Se mostrarán los procesos cuyo usuario efectivo sea el especificado."

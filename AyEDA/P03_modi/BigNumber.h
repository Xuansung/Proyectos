...
class BigNumberBadDigit : public BigNumberException {
 public:
  BigNumberBadDigit(const std::string& alert) : BigNumberException("BigNumberBadDigit: " + alert) {}
};

class BigNumberDivisionByZero : public BigNumberException {
 public:
  BigNumberDivisionByZero(const std::string& alert) : BigNumberException("BigNumberDivisionByZero: " + alert) {}
};
...
class BigNumber {
 public:
  ...
  virtual BigNumber<Base>& module(const BigNumber<Base>&) const = 0;

...
class NodoB {
 public:
  ...
  NodoB(const Key& dat, NodoB<Key>* i = nullptr, NodoB<Key>* d = nullptr)
      : dato(dat), izdo(i), dcho(d) {}
...
class NodoAVL : public NodoB<Key> {
 public:
  ...
  // Constructor por defecto
  NodoAVL(const Key& dat, NodoB<Key>* i = nullptr, NodoB<Key>* d = nullptr,
          int balFactor = 0)
      : NodoB<Key>(dat, i, d), bal(balFactor) {}
  // Destructor por defecto
  virtual ~NodoAVL() {}
};

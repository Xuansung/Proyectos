module cd(input wire clk, reset, r_inm, s_inc, we3, wef, push, pop, m_wr, s_wd, input wire [3:0] op_alu, output wire z, c, n, output wire [7:0] opcode, output wire [9:0] pc_salida);
